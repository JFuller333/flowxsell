  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-24 max-w-7xl mx-auto border-t border-primary/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <ProjectCard title="Children's Book Development" description="A 4-phase operating system for ecommerce founders: Audit, Align, Automate, XSell. Designed to transform fragmented growth into systematic scaling." tags={["Strategy", "Ecommerce", "Operations"]} image={flowosImage} />
          <ProjectCard title="LRB Donor & Investor Dashboard" description="Diagnostic tool that identifies where your systems break down. Get a clarity score and actionable next steps in under 5 minutes." tags={["Assessment", "Analytics", "Growth"]} image={healthScoreImage} />
          <ProjectCard title="AFL Mastery Framework" description="Strategic framework for building scalable marketing campaigns that compound over time instead of burning budgets." tags={["Marketing", "Systems", "ROI"]} image={campaignImage} />
          <ProjectCard title="FlowXSell Ecommerce Framework" description="Curated integration maps for connecting Shopify, email, analytics, and automation tools without the tech debt." tags={["Integration", "Automation", "Shopify"]} image={techStackImage} />
        </div>
      </section>
